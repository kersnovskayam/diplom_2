...
from constants import AUTH_REGISTER_ENDPOINT, AUTH_LOGIN_ENDPOINT
...
class TestRestApiLoginUser:
    ...
    def test_login_user(self):
        ...
        RegisterMethods.create_user(AUTH_REGISTER_ENDPOINT, TestData.NONE_VALUE, email, password, name)
        response = LoginMethods.login_user(AUTH_LOGIN_ENDPOINT, TestData.NONE_VALUE, email, password)
    ...
    def test_login_user_wrong_data(self):
        response = LoginMethods.login_user(AUTH_LOGIN_ENDPOINT, TestData.NONE_VALUE, TestData.WRONG_EMAIL, TestData.WRONG_PASSWORD)
