...
class TestRestApiCreateUser:
    ...
    def test_create_exists_user(self):
        response = RegisterMethods.create_user(AUTH_REGISTER_ENDPOINT, TestData.NONE_TOKEN, TestData.CREATED_EMAIL, TestData.CREATED_PASSWORD, TestData.CREATED_NAME)
    ...
    def test_create_user_without_required_fields(self):
        response = RegisterMethods.create_user(AUTH_REGISTER_ENDPOINT, TestData.NONE_TOKEN, TestData.CREATED_EMAIL, TestData.NONE_PASSWORD, TestData.NONE_NAME)
